...
initialization
  ...
  L10nOut[16, Eng] := 'Minimal inertia moment %.0F mm4';
  L10nOut[16, Rus] := 'Минимальный момент инерции %.0F мм4';
  ...
  L10nOut[40, Rus] := 'Температурный диапазон %.0F °C до %.0F °C';
  ...
  *)
  ...
  L10nGui[1, Ukr] := 'Ущільнення з трьох боків.' + sLineBreak +
  ...
  L10nGui[8, Ukr] := 'Ущільнення з чотирьох боків.' + sLineBreak +
    'Закриття вниз, відкриття вгору.' + sLineBreak + 'Гвинт з лівим різьбленням.';
  ...
  L10nGui[10, Ukr] := 'Штрабна (з обічайкою)';
  ...
  L10nGui[15, Ukr] := 'Ущільнення з трьох боків.' + sLineBreak +
  ...
  L10nGui[45, Ukr] := 'Покупні штурвали Ø%.0F...%.0F можна використовувати:' + LineEnding +
    ...
    'В інших випадках необхідно використовувати двосторонню рукоятку власного виготовлення.';
