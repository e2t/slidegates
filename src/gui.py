...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.rad_drive_spur = QtWidgets.QRadioButton(self.groupBox_2)
        self.rad_drive_spur.setObjectName("rad_drive_spur")
        self.verticalLayout_2.addWidget(self.rad_drive_spur)
        ...
        self.cmb_reducer.setEnabled(False)
        ...
        Dialog.setTabOrder(self.edt_flow_dist, self.cmb_auma)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rad_kind_flow.setText(_translate("Dialog", "Регулирующий"))
        self.groupBox_2.setTitle(_translate("Dialog", "Управление"))
        self.rad_drive_electric.setText(_translate("Dialog", "Электропривод"))
        self.rad_drive_reducer.setText(_translate("Dialog", "Угловой редуктор"))
        self.rad_drive_spur.setText(_translate("Dialog", "Цилиндрический редуктор"))
        ...
        self.cmb_install.setItemText(1, _translate("Dialog", "Бесштрабная"))
...
"Привод НЕ затапливается!"))
        ...
        self.grp_flow.setTitle(_translate("Dialog", "Для регулирующих затворов"))
        self.label_10.setText(_translate("Dialog", "От верха рамы до верха щита (м):"))
        self.groupBox_4.setTitle(_translate("Dialog", "Для конструктора"))
