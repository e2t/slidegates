...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_2.addWidget(self.edt_way, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_4.setTitle(_translate("Dialog", "Переопределить автовыбор"))
        self.label_5.setText(_translate("Dialog", "Ручной редуктор"))
        self.edt_way.setPlaceholderText(_translate("Dialog", "Автовыбор"))
        self.cmb_auma.setItemText(0, _translate("Dialog", "Автовыбор"))
        self.label.setText(_translate("Dialog", "Мотор-редуктор"))
        self.cmb_reducer.setItemText(0, _translate("Dialog", "Автовыбор"))
        self.label_11.setText(_translate("Dialog", "Промеж. опора в раме"))
        self.edt_screw.setPlaceholderText(_translate("Dialog", "Автовыбор"))
        ...
        self.rad_have_nodes_in_frame_auto.setText(_translate("Dialog", "Автовыбор"))
        self.rad_have_nodes_in_frame_none.setText(_translate("Dialog", "Без опор"))
        self.rad_wedge_pairs_auto.setText(_translate("Dialog", "Автовыбор"))
