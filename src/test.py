...
class TestWindow(MainWindow):
    def __init__(self) -> None:
        ...
        if __debug__:
            ...
            self.edt_frame_width.setText('1.2')
            self.edt_frame_height.setText('2.6')
            self.edt_gate_height.setText('1.2')
            self.edt_hydr_head.setText('5.5')
            ...
            self.edt_rack_dist.setText('3.48')
